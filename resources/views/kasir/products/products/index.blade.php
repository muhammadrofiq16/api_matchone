...
<div class="bg-white rounded-lg shadow p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('kasir.products.create') }}" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition">
            + Tambah Produk
        </a>
    </div>
                ...
                <tr class="border-b hover:bg-gray-50 transition">
                    ...
                    <td class="py-3 px-4">
                        <div class="flex justify-center gap-3">
                            <a href="{{ route('kasir.products.edit', $product->id) }}" class="text-blue-500 hover:text-blue-700">Edit</a>
                            <form action="{{ route('kasir.products.destroy', $product->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus produk ini?')">
                                @csrf
                                @method('DELETE')
