...
<div class="bg-white rounded-2xl shadow-md border border-gray-100 p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.categories.create') }}" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-xl text-sm font-semibold transition">
            + Tambah Kategori
        </a>
    </div>
                ...
                <tr class="border-b border-gray-50 hover:bg-gray-50 transition">
                    ...
                    <td class="py-3 px-2">
                        <div class="flex justify-center gap-2">
                            <a href="{{ route('admin.categories.edit', $category->id) }}" class="p-2 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition">
